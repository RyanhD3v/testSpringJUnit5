...
import org.nhbc.test.springboot.app.exceptions.DineroInsuficienteException;
import org.nhbc.test.springboot.app.models.Banco;
import org.nhbc.test.springboot.app.models.Cuenta;
import org.nhbc.test.springboot.app.repositories.BancoRepository;
...
import org.nhbc.test.springboot.app.sevices.CuentaServiceImpl;
...
//	@Mock
	...
	//@Mock -----> Mock con dependencia Mockito
	//@MockBean -----> Mock con springframework

//	@Mock
	@MockBean
	BancoRepository bancoRepository;
	/**
	 * se utiliza InjectMocks
	 * es necesario que sea el impl
	 * ya que contiene constructor
	 * eso verifica los mocks que sea del tipo de la interfaz
	 */
//	@InjectMocks
	@Autowired
...
//		Datos.BANCO.setTotalTransferencia(0);
	...
	void contextLoads3() {
		...
		assertEquals("Nestor", cuenta1.getPersona());
		assertEquals("Nestor", cuenta2.getPersona());
